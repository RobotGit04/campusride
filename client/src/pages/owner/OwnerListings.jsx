          ...
          <section className="mb-16 bg-surface-container-low p-8 rounded-xl border border-outline-variant/20">
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="flex flex-col gap-4">
                ...
                <label className="h-full min-h-50 border-2 border-dashed border-outline-variant/40 rounded-xl flex flex-col items-center justify-center bg-white/50 hover:bg-white transition-colors cursor-pointer group overflow-hidden">
                  {photoPreview ? (
                ...
                <div className="px-6 pb-6">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-surface-container">
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                      ...
                      <div className="w-11 h-6 bg-surface-container-highest rounded-full peer peer-checked:after:translate-x-full peer-checked:bg-secondary after:content-[''] after:absolute after:top-0.5 after:left-0.5 after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all"/>
                    </label>
                  </div>
                </div>
              </article>
