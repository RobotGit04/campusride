...
VIT AP University sits far from the city. Students need bikes on weekends but have no reliable way to find them. Owners have no way to advertise availability. CampusRide solves this with a real-time two-sided marketplace.
...
See the `/design/screenshots/` folder in this repository.
